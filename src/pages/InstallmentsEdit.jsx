...
const InstallmentsEdit = () => {
    ...
    if (fetching) return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
            ...
            <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em]">Loading Data...</p>
        </div>
    );
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 pb-20">
            <div className="max-w-6xl mx-auto p-6 space-y-8">
                ...
                <div className="relative overflow-hidden bg-gradient-to-r from-red-600 via-red-500 to-rose-600 rounded-3xl shadow-2xl p-8">
                    ...
                    <div>
                                <h1 className="text-3xl font-black text-white tracking-tight mb-2">Edit Installment Plan</h1>
                                <div className="flex items-center gap-3 flex-wrap">
                                    <p className="text-red-100 text-sm font-medium">Modification Mode Active</p>
                                    <span className="inline-flex items-center gap-1 px-3 py-1.5 bg-white/10 backdrop-blur-sm text-white rounded-xl text-xs font-bold border-2 border-white/20 shadow-lg">
                                        ID: {id}
                                    </span>
                                </div>
                    </div>
                                        ...
                                        <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                                            ...
                                            {loadingUser ? (
                                                ...
                                                <div className="text-center py-8 text-gray-500">
                                                    ...
                                                    <p className="text-sm mt-1">User ID: {form.user}</p>
                                                </div>
                                            ) : (
                                                <div className="text-center py-8 text-gray-500">
                                                    <svg className="w-12 h-12 mx-auto mb-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    <p className="text-sm mt-1">User ID is stored in the plan data</p>
                                                </div>
                                            )}
                                        </div>
