                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input required name="password" value={form.password} onChange={handleInputChange} type="password" placeholder="MIN. 8 CHARACTERS..." className="w-full px-6 py-4 bg-gray-50 border-2 border-transparent focus:border-red-600 rounded-2xl text-sm font-bold outline-none transition-all shadow-inner" />
                                </div>
                                <div className="space-y-2">
