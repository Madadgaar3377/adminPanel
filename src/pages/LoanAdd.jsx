    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok && data.success) {
                ...
                setError(data.message || 'Failed to create loan plan');
            }
        } catch (err) {
    ...
    return (
        <div className="space-y-4 xs:space-y-6 md:space-y-8 animate-in fade-in duration-500">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-4 xs:p-6 md:p-8 rounded-[1.5rem] xs:rounded-[2rem] md:rounded-[2.5rem] shadow-sm border border-gray-100">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 xs:gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g., Personal, Business, Startup"
                                />
                            </div>
                ...
                {activeTab === 'financial' && (
                    <div className="space-y-4 xs:space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 xs:gap-6">
                            ...
                            <div>
                                <label className="block text-[9px] xs:text-[10px] font-black text-gray-400 uppercase tracking-wider xs:tracking-widest mb-2">Income Bracket</label>
                                <input
                                    type="text"
                                    name="incomeBracket"
                            ...
                            <div className="sm:col-span-2">
                                <label className="block text-[9px] xs:text-[10px] font-black text-gray-400 uppercase tracking-wider xs:tracking-widest mb-2">Net Worth / Available Capital</label>
                                <input
                                    type="text"
                                    name="netWorthAvailCapital"
                                    value={formData.netWorthAvailCapital}
                                    onChange={handleChange}
                                    className="w-full px-3 xs:px-4 py-2.5 xs:py-3 bg-gray-50 border-2 border-transparent focus:border-red-600 rounded-lg xs:rounded-xl text-xs xs:text-sm font-bold transition-all outline-none"
                                />
                            </div>
                ...
                {activeTab === 'business' && (
                    <div className="space-y-4 xs:space-y-6">
                        <h3 className="text-base xs:text-lg font-black text-gray-900 uppercase tracking-tighter pb-3 xs:pb-4 border-b border-gray-100">Business Information</h3>
                        
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 xs:gap-6">
                            <div>
                                <label className="block text-[9px] xs:text-[10px] font-black text-gray-400 uppercase tracking-wider xs:tracking-widest mb-2">Business Structure</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-[9px] xs:text-[10px] font-black text-gray-400 uppercase tracking-wider xs:tracking-widest mb-2">Relevant Experience</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-[9px] xs:text-[10px] font-black text-gray-400 uppercase tracking-wider xs:tracking-widest mb-2">Length of Current Employment/Business</label>
                                <input
                                    type="text"
                                    name="lenOfCurrentEmpOrBusiness"
                                    value={formData.lenOfCurrentEmpOrBusiness}
                                    onChange={handleChange}
                                    className="w-full px-3 xs:px-4 py-2.5 xs:py-3 bg-gray-50 border-2 border-transparent focus:border-red-600 rounded-lg xs:rounded-xl text-xs xs:text-sm font-bold transition-all outline-none"
                                />
                            </div>
                            ...
                            <div>
                                <label className="block text-[9px] xs:text-[10px] font-black text-gray-400 uppercase tracking-wider xs:tracking-widest mb-2">Persons Involved in Business</label>
                                <input
                                    type="text"
                                    name="personInvolvedInBusiness"
                                    value={formData.personInvolvedInBusiness}
                                    onChange={handleChange}
                                    className="w-full px-3 xs:px-4 py-2.5 xs:py-3 bg-gray-50 border-2 border-transparent focus:border-red-600 rounded-lg xs:rounded-xl text-xs xs:text-sm font-bold transition-all outline-none"
                                />
                            </div>
                            ...
                            <div>
                                <label className="block text-[9px] xs:text-[10px] font-black text-gray-400 uppercase tracking-wider xs:tracking-widest mb-2">Equity Investment</label>
                                <input
                                    type="text"
                                    name="equityInvestment"
                                    value={formData.equityInvestment}
                                    onChange={handleChange}
                                    className="w-full px-3 xs:px-4 py-2.5 xs:py-3 bg-gray-50 border-2 border-transparent focus:border-red-600 rounded-lg xs:rounded-xl text-xs xs:text-sm font-bold transition-all outline-none"
                                />
                            </div>
                            ...
                            <div>
                                <label className="block text-[9px] xs:text-[10px] font-black text-gray-400 uppercase tracking-wider xs:tracking-widest mb-2">Any Bank Financing?</label>
                                <select
                                    name="anyBankFinancing"
                                    value={formData.anyBankFinancing}
                                    onChange={handleChange}
                                    className="w-full px-3 xs:px-4 py-2.5 xs:py-3 bg-gray-50 border-2 border-transparent focus:border-red-600 rounded-lg xs:rounded-xl text-xs xs:text-sm font-bold transition-all outline-none"
                                >
                                    <option value="">Select</option>
                ...
                <div className="flex flex-col xs:flex-row gap-3 xs:gap-4 mt-6 xs:mt-8 pt-6 xs:pt-8 border-t border-gray-100">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className={`tap-target flex-1 py-3 xs:py-3.5 px-4 bg-red-600 text-white rounded-xl xs:rounded-2xl font-black uppercase text-[10px] xs:text-xs tracking-wider xs:tracking-widest hover:bg-red-700 transition-all shadow-lg shadow-red-100 ${loading ? 'opacity-70 cursor-not-allowed' : 'active:scale-95'}`}
                    >
                        {loading ? (
